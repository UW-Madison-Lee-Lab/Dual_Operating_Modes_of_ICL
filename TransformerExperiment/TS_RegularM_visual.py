...
if 1:
    ...
    for col, M in enumerate(M_list):
        print('***** M=' +str(M)+ ' *****')
        folder = 'data/Transformer/'+fig_name+'/M='+str(M)+'/'
        ...
        for epoch in range(1, args.epochs+1):
            ...
            if 1: #evaluation
                ...
                if T_flag:
                    ...
                    #axes[epoch-1,col].fill_between(range(len(means)), lower_bound, upper_bound, color='blue', alpha=0.15)
                    ...
                    #axes[epoch-1,col].fill_between(range(len(means)), lower_bound, upper_bound, color='red' , alpha=0.15)
            ...
            if epoch == 1:
                ...
                axes[epoch-1,col].set_ylim([1/10**2.5,10**0])
                axes[epoch-1,col].set_yscale('log')
            
                axes[epoch-1,col].set_title(r'$M= $'+' '+str(M))
