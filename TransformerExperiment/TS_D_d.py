...
parser.add_argument('--d', default=0, type=int, help='D_num')

parser.set_defaults(augment=True)

setproctitle.setproctitle('T D d')
...
if 1:
    ...
    fig_name = 'D_d_lr='+str(args.lr)+'_Depth='+str(args.depth)+'_EmbDim='+str(args.embed_dim)+'_BS='+str(args.batch_size)+'_Step='+str(args.steps)
