...
def call_gptapi(
    ...
    openai_key = 'none',
    logprobs = False,
    sys_msg = "You are a mathematician. Consider the following math problem and follow the exact instruction.",#"You are a mathematician. Consider the following prime number task and follow the exact instruction.",
):
